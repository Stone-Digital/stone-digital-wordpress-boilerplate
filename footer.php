	            ...
	            if( have_rows('locations','options') ):
	                while( have_rows('locations','options') ) : the_row();
	                    ...
	                    <?php if($heading_with_link): ?>
	                        <h5 class="heading--link">
	                        	<a 
	                        	href="<?= $heading_with_link['url']; ?>" 
	                        	target="<?= $heading_with_link['target'] ? $heading_with_link['target'] : '_self'; ?>" 
	                        	aria-label="<?= $heading_with_link['title']; ?>"><?= $heading_with_link['title']; ?>
	                        	</a>
	                        </h5>
	                    <?php endif; ?>
	                    <?php if($address): ?>
