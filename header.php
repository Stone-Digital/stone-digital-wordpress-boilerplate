...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<header class="masthead">
							...
							if ( have_rows( 'navigation_link' ) ) :
								...
								while ( have_rows( 'navigation_link' ) ) :
									...
									<div class="base--link--wrapper">
										<a
											href="<?php echo esc_url( $base_link['url'] ); ?>"
											aria-label="<?php echo esc_attr( $base_link['title'] ); ?>"
											target="<?php echo ! empty( $base_link['target'] ) ? esc_attr( $base_link['target'] ) : '_self'; ?>"
											class="parent--link">
											<?php echo esc_html( $base_link['title'] ); ?>
											...
											if ( have_rows( 'sub_link' ) ) :
												...
												<div class="sub-link-item">
													...
													endwhile;
												?>
											<button class="switch-button" data-attr="rural">Switch to Rural Structures <img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/switch.svg" alt="switch"/></button>
		...
		<nav class="navigation__menu" data-attr="rural" style="display:none;">
			<div class="navigation__rural_sub rural--logo">
				<a href="<?php echo home_url(); ?>" aria-label="Bison Construction">
					<img
					src="<?php echo get_template_directory_uri() . '/assets/images/svg/bison_logo.svg'; ?>"
			...
			<div class="navigation__rural--sub rural--menu">
				<div class="navigation__rural--sub--sub">
					...
					if ( have_rows( 'rural_navigation', 'options' ) ) :
						...
						while ( have_rows( 'rural_navigation', 'options' ) ) :
							the_row();
									...
									<div class="base--link--wrapper">
										<a
											...
											if ( have_rows( 'sub_link' ) ) :
												...
												endwhile;
												?>
											<button class="switch-button" data-attr="industrial">Switch to Industrial Structures <img src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/switch.svg" alt="switch"/></button>
